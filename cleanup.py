...
def get_topology_root_uri():
	return "/restconf/config/network-topology:network-topology/"

def get_inventory_root_uri():
...
if __name__ == "__main__":
    ...
    #print "deleting topology configuration"
    #delete(controller, DEFAULT_PORT, get_topology_root_uri())
    
    #print "deleting inventory configuration"
    #delete(controller, DEFAULT_PORT, get_inventory_root_uri())
