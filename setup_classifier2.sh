...
sudo ip netns exec app ifconfig veth-app 10.0.0.3/24 up
sudo ip netns exec app ip link set dev veth-app  addr 00:00:00:00:00:03
sudo ip netns exec app arp -s 10.0.0.1 00:00:00:00:00:01 -i veth-app
