...
def start(ip="192.168.137.110",port=6633):
    ...
    #c2 = net.addController('c2',controller=RemoteController, ip='192.168.137.100',port=6653)
    ...
    net.addLink(s1, r1, 3, 1, cls=LINCLink)
    net.addLink(s1, r1, 4, 2, cls=LINCLink)
    net.addLink(s2, r2, 3, 1, cls=LINCLink)
    net.addLink(s2, r2, 4, 2, cls=LINCLink)
